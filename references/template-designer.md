...
- Generic layout pattern library, spacing bands, font-size ratio bands → [`templates/reference/design_spec_reference.md`](../templates/reference/design_spec_reference.md) (read by Strategist when authoring the **project** design_spec)
...
```
templates/layouts/
├── academic_general/      # Classic academic defense style
├── defense_leftnav/       # Compact wine-red thesis defense style
├── defense_topnav/       # Academic-blue top-navigation defense style
└── literature_minimal/    # Minimal blue literature report family
```
