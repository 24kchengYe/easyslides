...
This workflow is **independent**: it owns the source-acquisition step only when the user supplies no source materials; subsequent SKILL.md steps proceed normally with the produced materials as input. It may download relevant openly licensed images as PPT assets, with provenance and license notes.

If source materials are provided, do not run this workflow as a replacement for them. Journal papers, theses/dissertations, mature reports, existing decks, and other figure/text-rich files are source-of-truth inputs; preserve their claims, figures, tables, captions, and structure unless the user explicitly asks for external supplementation.
...
| Source file attached (PDF / DOCX / URL / Markdown / thesis / report / paper) | Skip — go to SKILL.md Step 1 source converter |
